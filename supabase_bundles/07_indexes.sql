-- ============================================================
-- BUNDLE 7 — Performance indexes
-- Bundle for NEW Supabase project setup
-- Run order step: 7 of 7
-- Source files (in order):
--   - supabase_migration_performance_indexes.sql
--   - supabase_migration_history_indexes.sql
-- Idempotent where possible (safe to re-run after a partial failure).
-- ============================================================


-- ------------------------------------------------------------
-- BEGIN: supabase_migration_performance_indexes.sql
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- END: supabase_migration_performance_indexes.sql
-- ------------------------------------------------------------


-- ------------------------------------------------------------
-- BEGIN: supabase_migration_history_indexes.sql
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- END: supabase_migration_history_indexes.sql
-- ------------------------------------------------------------
