-- ============================================================
-- One workplace geofence for clock-in
...
-- Clock-in: approved leave + optional one-site geofence when work_site.is_active.
...
BEGIN
  ...
  -- Geofence (only when an active singleton site exists)
  SELECT * INTO v_site
